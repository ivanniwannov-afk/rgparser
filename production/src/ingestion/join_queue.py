        ...
        while not self._stop_event.is_set():
            try:
                ...
                if task.scheduled_at <= now:
                    ...
                    # Check which condition completed
                    if stop_task in done:
                        # Stop event was set
                        return None
                    elif new_task_task in done:
                        # New task arrived, clear the event and re-evaluate queue
